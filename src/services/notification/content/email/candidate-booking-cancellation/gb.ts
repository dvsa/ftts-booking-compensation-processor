...
export default {
  subject: 'DVSA: Your driving theory test is CANCELLED',
  buildBody: async (details: BookingCancellationDetails, target: Target): Promise<string> => dedent`
    ...
    You can [book a replacement test on GOV.UK](https://www.gov.uk/book-theory-test): https://www.gov.uk/book-theory-test

    If you are a driving instructor use: [https://www.gov.uk/book-your-instructor-theory-test](https://www.gov.uk/book-your-instructor-theory-test)
    ...
    You can request a refund online at: [https://www.gov.uk/change-theory-test](https://www.gov.uk/change-theory-test)

    If you are a driving instructor use: [https://www.gov.uk/check-change-cancel-your-instructor-theory-test](https://www.gov.uk/check-change-cancel-your-instructor-theory-test)
